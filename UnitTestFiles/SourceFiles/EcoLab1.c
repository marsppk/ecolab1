...
void PrintSimpleCountingSortTestResultsInt(IEcoMemoryAllocator1 *pIMem, IEcoLab1 *lab1, size_t n_elems, int sortingOrder) {
    ...
    int32_t* arr = CreateSimpleIntArray(pIMem, n_elems);
    printf("Before:\n");
...
int16_t EcoMain(IEcoUnknown* pIUnk) {
    ...
    /* Указатели на тестируемый интерфейс */
    ...
    result = pIBus->pVTbl->QueryComponent(pIBus, &CID_EcoLab1String, 0, &IID_IEcoLab1, (void**) &pIEcoLab1String);
    if (result != 0 || pIEcoLab1String == 0) {
